...
public class GlitchEffect : MonoBehaviour
{
	...
	[Header("Level Of All Intensity")]
	[SerializeField] private float _intensityLow = 0.3f;
	[SerializeField] private float _intensityMed = 0.55f;
	[SerializeField] private float _intensityHigh = 0.8f;
	...
	public void SetGlitchEfx(float newValue){
		intensity = newValue;
		flipIntensity = newValue;
		colorIntensity = newValue;
	}

	public void ShowEfx(int level)
	{
		float glitchValue = level switch{
			1 => _intensityLow,
			2 => _intensityMed,
			3 => _intensityHigh,
			_ => 0f,
